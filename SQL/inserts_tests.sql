...
insert INTO Gruppe values(5, 'PRP2', 3, 3, 11); /*Testgruppe - Teamanmeldeprozess */
insert INTO Gruppe values(6, 'PRP2', 2, 3, 11); /*Testgruppe - Anmeldung ablehnen */


insert INTO Gruppe values(1, 'DBP', 14, 4, 33);
insert INTO Gruppe values(2, 'DBP', 14, 4, 22);
insert INTO Gruppe values(3, 'DBP', 14, 4, 33);
insert INTO Gruppe values(4, 'DBP', 14, 4, 33); /* Testgruppe 1 */
insert INTO Gruppe values(5, 'DBP', 14, 4, 33); /* Testgruppe  verlasse team */

insert INTO Gruppe values(1, 'BSP', 14, 1, 11);
insert INTO Gruppe values(2, 'BSP', 14, 1, 11);
insert INTO Gruppe values(3, 'BSP', 14, 1, 11);
insert INTO Gruppe values(4, 'BSP', 14, 1, 11); /* Testgruppe 2*/
